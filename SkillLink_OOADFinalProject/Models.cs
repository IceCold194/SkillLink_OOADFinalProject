...
namespace SkillLink_OOADFinalProject
{
    ...
    // =======================================================
    // EXAMPLE UI USAGE (How this would be called in a WinForms button click)
    // =======================================================

    /*
    // In your main Form class, you would initialize the manager:
    ...
    private void btnAddTrainee_Click(object sender, EventArgs e)
    {
        try 
        {
            ...
            string contact = txtTraineeContact.Text;
            ...
            dgvTrainees.DataSource = null; 
            dgvTrainees.DataSource = manager.Trainees;
        }
        catch (Exception ex)
        {
    ...
    private void btnCertify_Click(object sender, EventArgs e)
    {
        ...
        if (int.TryParse(txtTraineeIdToCertify.Text, out int id))
        {
